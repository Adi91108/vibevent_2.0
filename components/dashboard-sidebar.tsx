        ...
        <div className="flex items-center justify-start">
          ...
          {isHovered && (
            <div className="ml-3 overflow-hidden">
              <h2 className="text-lg font-semibold text-orange whitespace-nowrap">
                Event Easee
              </h2>
            </div>
          )}
    ...
    <div className="flex flex-col h-full bg-white shadow-lg border-r border-gray-200">
      ...
      <div className="p-4 lg:p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 lg:w-10 lg:h-10 bg-milk rounded-full flex items-center justify-center">
              <Image
                src="/logo5.png"
                alt="Calendar icon"
                width={36}
            ...
            <div>
              <h2 className="text-base lg:text-lg font-semibold text-orange">
                Event Easee
              </h2>
            </div>
          </div>
          <button
            ...
            className="lg:hidden p-2 rounded-md text-orange hover:text-gray-500 hover:bg-gray-100"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center space-x-3 px-3 py-2 rounded-md text-sm font-medium transition-colors ${
                item.current
                  ? "bg-blue-50 text-orange border-r-2 border-bubblegum"
                  : "text-gray-700 hover:bg-gray-50 hover:text-gray-900"
              }`}
            >
              <Icon className="w-5 h-5 flex-shrink-0" />
      ...
      <div className="p-3 lg:p-4 border-t border-gray-200">
        <Button
          ...
          onClick={() => signOut({ callbackUrl: '/' })}
        >
          <LogOut className="w-4 h-4 mr-2 flex-shrink-0 bg-blue-50  " />
          Sign Out
        </Button>
      </div>
    </div>
    ...
    <>
      ...
      <div className="lg:hidden fixed top-4 left-4 z-50">
        <Button
          ...
          className="bg-milk shadow-md"
        >
          <Menu className="w-4 h-4 text-orange" />
        </Button>
      </div>
