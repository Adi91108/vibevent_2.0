...
export default function EventPublicView({ event }: EventPublicViewProps) {
  ...
  return (
    <div className="min-h-screen bg-milk">
      {/* Hero Section */}
      <div className="bg-milk border-b border-slate-200">
          ...
          <div className="mx-auto max-w-6xl">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-orange mb-3">
                  {event.title}
                </h1>
                {event.description && (
            ...
            <div className="lg:col-span-2">
              <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200">
                <CardHeader className="pb-4 sm:pb-6">
                  <CardTitle className="text-xl sm:text-2xl font-bold text-orange">
                    Event Details
                  </CardTitle>
                </CardHeader>
                    ...
                    <div className="group">
                      <div className="flex items-start space-x-4 p-4 sm:p-5 rounded-lg border border-slate-200 hover:border-slate-300 transition-colors duration-200 bg-white">
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="font-semibold text-orange mb-1 text-sm sm:text-base">
                            Date & Time
                          </h3>
                ...
                {success ? (
                  ...
                  <Card className="border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-200 bg-white">
                    <CardHeader className="text-center pb-4">
                      <CardTitle className="text-xl sm:text-2xl text-orange">
