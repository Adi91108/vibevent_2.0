...
export default function UserManagement({ users, currentUserId }: UserManagementProps) {
  ...
  return (
    <div className="flex-1 bg-milk p-4 sm:p-6 lg:p-8 pt-16 lg:pt-8">
      {/* Page Header */}
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-4 mb-6 lg:mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-orange">User Management</h1>
      ...
      <Card className="hidden lg:block">
        <CardHeader>
          <CardTitle className="text-orange">Users</CardTitle>
